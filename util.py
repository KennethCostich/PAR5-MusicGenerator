# NOTE: For out final project in CS4100, we (Kenneth Costich and Maxwell 
# Salvadore) have decided to use to file from our programming assignments
# to define data structures used in our project.  This code is not our 
# own.  Information regarding the origin of this file can be found below:
